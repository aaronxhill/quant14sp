fp <- "/Users/aaron/tns/datasets" # update with location of the 6 csv files used in this class: 
# country.csv, drugtreatment.csv, empdat.csv, instructorevals.csv, lowbwt.csv, states.csv
...
id.description <- "ID"
educ.description <- "education, in years"
jobcat.description <- "job type"
salary.description <- "current salary"
salbegin.description <- "salary at start of current job"
jobtime.description <- "years spent in current job"
prevexp.description <- "years of previous work experience"
minority.description <- "race: ='yes' if minority (nonwhite)"
